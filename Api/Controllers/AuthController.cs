...
using Bit.TodoTemplatePlayground.Api.Resources;
using Bit.TodoTemplatePlayground.Api.Models.Account;
using Bit.TodoTemplatePlayground.Shared.Dtos.Account;
using Bit.TodoTemplatePlayground.Api.Models.Emailing;

namespace Bit.TodoTemplatePlayground.Api.Controllers;
...
public partial class AuthController : ControllerBase
{
    ...
    private async Task SendConfirmationEmail(SendConfirmationEmailRequestDto sendConfirmationEmailRequest, User user, CancellationToken cancellationToken)
    {
        ...
        var result = await _fluentEmail
            ...
            .UsingTemplateFromEmbedded("Bit.TodoTemplatePlayground.Api.Resources.EmailConfirmation.cshtml",
        ...
        , CancellationToken cancellationToken)
    {
        ...
        var result = await _fluentEmail
            ...
            .UsingTemplateFromEmbedded("Bit.TodoTemplatePlayground.Api.Resources.ResetPassword.cshtml",
